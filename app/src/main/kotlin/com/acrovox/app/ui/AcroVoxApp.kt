...
fun AcroVoxApp(
    ...
    // Le lecteur plein écran occupe tout l'écran.
    val fullPlayer = destination?.hasRoute(PlayerRoute::class) == true
            ...
            if (!fullPlayer) {
                Column {
                    AnimatedVisibility(
                        ...
                        MiniPlayer(
                            state = playerState,
                            onOpen = { navController.navigate(PlayerRoute) },
